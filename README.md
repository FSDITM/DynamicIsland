...
| | |
|---|---|
| **Покой** | 0.06% одного ядра — установленное приложение, курсор вдали от островка |
| **Анимация** | 60 fps, 1.9–2.3 мс процессорного времени на кадр |
| **Первый кадр** | ~100 мс — разовая компиляция шейдеров |
| **Память** | ~87 МБ приватной, ~145 МБ рабочий набор |
...
| `--mediainfo` | что система знает о воспроизведении и какой источник выберет островок |
